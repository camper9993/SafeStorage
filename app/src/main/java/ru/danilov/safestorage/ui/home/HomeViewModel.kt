...
class HomeViewModel @ViewModelInject constructor(private val getFilesUseCase: GetFilesUseCase, private val decryptFileUseCase: DecryptFileUseCase) : ViewModel(){
